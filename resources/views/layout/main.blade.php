   ...
   <body class="sidebar-main-active right-column-fixed header-top-bgcolor">
      ...
      <div class="wrapper">
         ...
         <div class="iq-sidebar">
             @if (request()->routeIs('bab1') || request()->routeIs('bab1.*'))
               @include('layout.bab1.sidebar')
            @elseif (request()->routeIs('bab2') || request()->routeIs('bab2.*'))
               @include('layout.bab2.sidebar')
            @elseif (request()->routeIs('bab3') || request()->routeIs('bab3.*'))
               @include('layout.bab3.sidebar')
            @elseif (request()->routeIs('bab4') || request()->routeIs('bab3.*'))
               @include('layout.bab4.sidebar')
            @elseif (request()->routeIs('bab4') || request()->routeIs('bab4.*'))
               @include('layout.bab4.sidebar')
            @elseif (request()->routeIs('bab5') || request()->routeIs('bab5.*'))
               @include('layout.bab5.sidebar')
            @elseif (request()->routeIs('bab6') || request()->routeIs('bab6.*'))
               @include('layout.bab6.sidebar')
            @endif
         </div>
         <!-- TOP Nav Bar -->
